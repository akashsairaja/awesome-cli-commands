---
id: aitools-ai-agent-development
stackId: aitools
type: skill
name: AI Agent Development
description: >-
  AI agent development workflow for building autonomous agents, multi-agent
  systems, and agent orchestration with CrewAI, LangGraph, and custom agents.
difficulty: advanced
tags:
  - aitools
  - agent
...
compatibility:
  - claude-code
faq:
  - question: "When should I use the AI Agent Development skill?"
    answer: >-
      AI agent development workflow for building autonomous agents,
      multi-agent systems, and agent orchestration with CrewAI, LangGraph, and
      custom agents. This skill provides a structured workflow for prompt
      engineering, RAG pipelines, LLM application development, and AI agent
      building.
  - question: "What tools and setup does AI Agent Development require?"
    answer: >-
