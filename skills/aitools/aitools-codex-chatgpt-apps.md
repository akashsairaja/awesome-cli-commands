...
compatibility:
  - codex
faq:
  - question: "When should I use the ChatGPT App Development skill?"
    answer: >-
      Build, scaffold, refactor, and troubleshoot ChatGPT Apps SDK
      applications that combine an MCP server and widget UI. This skill
      provides a structured workflow for prompt engineering, RAG pipelines,
      LLM application development, and AI agent building.
  - question: "What tools and setup does ChatGPT App Development require?"
    answer: >-
