...
description: >-
  ...
  batch variants); run the bundled CLI (`scripts/image_gen.
difficulty: advanced
tags:
  - aitools
  - image
...
compatibility:
  - codex
faq:
  - question: "When should I use the AI Image Generation skill?"
    answer: >-
      Use when the user asks to generate or edit images via the OpenAI Image
      API (for example: generate image, edit/inpaint/mask, background removal
      or replacement, transparent background, product shots, concept art,
      covers, or batch variants); run the bundled CLI (`scripts/image_gen.
      This skill provides a structured workflow for prompt engineering, RAG
      pipelines, LLM application development, and AI agent building.
  - question: "What tools and setup does AI Image Generation require?"
    answer: >-
