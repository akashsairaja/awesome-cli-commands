---
id: aitools-codex-linear
stackId: aitools
type: skill
name: Linear Project Integration
description: >-
...
compatibility:
  - codex
faq:
  - question: "When should I use the Linear Project Integration skill?"
    answer: >-
      Manage issues, projects & team workflows in Linear. This skill provides
      a structured workflow for prompt engineering, RAG pipelines, LLM
      application development, and AI agent building.
  - question: "What tools and setup does Linear Project Integration require?"
    answer: >-
