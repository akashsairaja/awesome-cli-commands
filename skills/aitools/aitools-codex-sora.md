---
id: aitools-codex-sora
stackId: aitools
type: skill
name: Sora Video Generation
description: >-
  Use when the user asks to generate, remix, poll, list, download, or delete
  Sora videos via OpenAI’s video API using the bundled CLI (`scripts/sora.
...
compatibility:
  - codex
faq:
  - question: "When should I use the Sora Video Generation skill?"
    answer: >-
      Use when the user asks to generate, remix, poll, list, download, or
      delete Sora videos via OpenAI’s video API using the bundled CLI
      (`scripts/sora. This skill provides a structured workflow for prompt
      engineering, RAG pipelines, LLM application development, and AI agent
      building.
  - question: "What tools and setup does Sora Video Generation require?"
    answer: >-
