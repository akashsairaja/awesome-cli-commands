---
id: aitools-codex-transcribe
stackId: aitools
type: skill
name: Audio Transcription
description: >-
  Transcribe audio files to text with optional diarization and known-speaker
  hints.
...
compatibility:
  - codex
faq:
  - question: "When should I use the Audio Transcription skill?"
    answer: >-
      Transcribe audio files to text with optional diarization and
      known-speaker hints. This skill provides a structured workflow for
      prompt engineering, RAG pipelines, LLM application development, and AI
      agent building.
  - question: "What tools and setup does Audio Transcription require?"
    answer: >-
