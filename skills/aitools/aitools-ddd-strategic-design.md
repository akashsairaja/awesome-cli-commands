---
id: aitools-ddd-strategic-design
stackId: aitools
type: skill
name: DDD Strategic Design
description: >-
  Design DDD strategic artifacts including subdomains, bounded contexts, and
  ubiquitous language for complex business domains.
difficulty: beginner
tags:
  - aitools
  - ddd
...
compatibility:
  - claude-code
faq:
  - question: "When should I use the DDD Strategic Design skill?"
    answer: >-
      Design DDD strategic artifacts including subdomains, bounded contexts,
      and ubiquitous language for complex business domains. It includes
      practical examples for AI/ML development development.
  - question: "What tools and setup does DDD Strategic Design require?"
    answer: >-
