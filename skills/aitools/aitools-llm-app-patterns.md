...
compatibility:
  - claude-code
faq:
  - question: "When should I use the LLM App Patterns skill?"
    answer: >-
      Production-ready patterns for building LLM applications. This skill
      provides a structured workflow for prompt engineering, RAG pipelines,
      LLM application development, and AI agent building.
  - question: "What tools and setup does LLM App Patterns require?"
    answer: >-
