...
name: LLM Ops
description: >-
  LLM Operations -- RAG, embeddings, vector databases, fine-tuning, prompt
...
compatibility:
  - claude-code
faq:
  - question: "When should I use the LLM Ops skill?"
    answer: >-
      LLM Operations -- RAG, embeddings, vector databases, fine-tuning, prompt
      engineering avancado, custos de LLM, evals de qualidade e arquiteturas
      de IA para producao.
  - question: "What tools and setup does LLM Ops require?"
    answer: >-
