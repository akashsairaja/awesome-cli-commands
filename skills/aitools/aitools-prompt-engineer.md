...
description: >-
  Transforms user prompts into optimized prompts using frameworks (RTF, RISEN,
  Chain of Thought, RODES, Chain of Density, RACE, RISE, STAR, SOAP, CLEAR,
  GROW).
difficulty: advanced
tags:
  - aitools
...
compatibility:
  ...
  - copilot
faq:
  - question: "When should I use the Prompt Engineer skill?"
    answer: >-
      Transforms user prompts into optimized prompts using frameworks (RTF,
      RISEN, Chain of Thought, RODES, Chain of Density, RACE, RISE, STAR,
      SOAP, CLEAR, GROW). This skill provides a structured workflow for prompt
      engineering, RAG pipelines, LLM application development, and AI agent
      building.
  - question: "What tools and setup does Prompt Engineer require?"
    answer: >-
