---
id: aitools-rag-implementation
stackId: aitools
type: skill
name: RAG Implementation
description: >-
  RAG (Retrieval-Augmented Generation) implementation workflow covering
  embedding selection, vector database setup, chunking strategies, and
...
compatibility:
  - claude-code
faq:
  - question: "When should I use the RAG Implementation skill?"
    answer: >-
      RAG (Retrieval-Augmented Generation) implementation workflow covering
      embedding selection, vector database setup, chunking strategies, and
      retrieval optimization. This skill provides a structured workflow for
      prompt engineering, RAG pipelines, LLM application development, and AI
      agent building.
  - question: "What tools and setup does RAG Implementation require?"
    answer: >-
