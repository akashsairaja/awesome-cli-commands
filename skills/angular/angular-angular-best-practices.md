---
id: angular-angular-best-practices
stackId: angular
type: skill
name: Angular Best Practices
description: >-
  Comprehensive performance optimization guide for Angular applications.
  Contains prioritized rules for eliminating performance bottlenecks,
  optimizing bundles, and improving rendering.
difficulty: advanced
tags:
  - angular
  - best
...
compatibility:
  - claude-code
faq:
  - question: "When should I use the Angular Best Practices skill?"
    answer: >-
      Comprehensive performance optimization guide for Angular applications.
      Contains prioritized rules for eliminating performance bottlenecks,
      optimizing bundles, and improving rendering. This skill provides a
      structured workflow for component architecture, dependency injection,
      state management, and enterprise patterns.
  - question: "What tools and setup does Angular Best Practices require?"
    answer: >-
      Requires pip/poetry installed. Works with Angular projects. Review the
