...
compatibility:
  - claude-code
faq:
  - question: "When should I use the Angular Core Patterns skill?"
    answer: >-
      Modern Angular (v20+) expert with deep knowledge of Signals, Standalone
      Components, Zoneless applications, SSR/Hydration, and reactive patterns.
      It includes practical examples for Angular enterprise development.
  - question: "What tools and setup does Angular Core Patterns require?"
    answer: >-
