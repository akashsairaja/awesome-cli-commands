---
id: angular-angular-migration
stackId: angular
type: skill
name: Angular Migration
description: >-
  Migrate from AngularJS to Angular using hybrid mode, incremental component
  rewriting, and dependency injection updates.
difficulty: advanced
tags:
  - angular
  - migration
...
compatibility:
  - claude-code
faq:
  - question: "When should I use the Angular Migration skill?"
    answer: >-
      Migrate from AngularJS to Angular using hybrid mode, incremental
      component rewriting, and dependency injection updates. It includes
      practical examples for Angular enterprise development.
  - question: "What tools and setup does Angular Migration require?"
    answer: >-
      Works with standard Angular tooling (Angular CLI, RxJS). Review the
