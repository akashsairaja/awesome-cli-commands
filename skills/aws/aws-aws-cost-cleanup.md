---
id: aws-aws-cost-cleanup
stackId: aws
type: skill
name: AWS Cost Cleanup
description: >-
  Automate the identification and removal of unused AWS resources to eliminate
  waste. Use this skill when you need to automatically clean up unused AWS
  resources to reduce costs and eliminate waste.
difficulty: advanced
tags:
  - aws
  - cost
...
compatibility:
  - claude-code
faq:
  - question: "When should I use the AWS Cost Cleanup skill?"
    answer: >-
      Automate the identification and removal of unused AWS resources to
      eliminate waste. Use this skill when you need to automatically clean up
      unused AWS resources to reduce costs and eliminate waste. This skill
  ...
  - question: "What tools and setup does AWS Cost Cleanup require?"
    answer: >-
