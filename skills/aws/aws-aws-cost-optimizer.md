---
id: aws-aws-cost-optimizer
stackId: aws
type: skill
name: AWS Cost Optimizer
description: >-
  Comprehensive AWS cost analysis and optimization recommendations using AWS
  CLI and Cost Explorer.
...
compatibility:
  - claude-code
faq:
  - question: "When should I use the AWS Cost Optimizer skill?"
    answer: >-
      Comprehensive AWS cost analysis and optimization recommendations using
      AWS CLI and Cost Explorer. This skill provides a structured workflow for
      serverless architecture, cost optimization, security hardening, and
      infrastructure automation.
  - question: "What tools and setup does AWS Cost Optimizer require?"
    answer: >-
      Requires AWS CLI installed. Works with AWS projects. No additional
