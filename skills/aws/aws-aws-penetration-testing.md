---
id: aws-aws-penetration-testing
stackId: aws
type: skill
...
compatibility:
  - claude-code
faq:
  - question: "When should I use the AWS Penetration Testing skill?"
    answer: >-
      This skill should be used when the user asks to "pentest AWS", "test AWS
      security", "enumerate IAM", "exploit cloud infrastructure", "AWS
      privilege escalation", "S3 bucket testing. This skill provides a
      structured workflow for serverless architecture, cost optimization,
      security hardening, and infrastructure automation.
  - question: "What tools and setup does AWS Penetration Testing require?"
    answer: >-
      Requires AWS CLI, pip/poetry installed. Works with AWS projects. Review
