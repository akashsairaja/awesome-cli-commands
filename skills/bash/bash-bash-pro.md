...
description: >-
  ...
  pipelines, and system utilities.
...
compatibility:
  - claude-code
faq:
  - question: "When should I use the Bash Pro skill?"
    answer: >-
      Master of defensive Bash scripting for production automation, CI/CD
      pipelines, and system utilities. This skill provides a structured
      workflow for automation scripts, argument parsing, error handling, and
      system administration.
  - question: "What tools and setup does Bash Pro require?"
    answer: >-
      Requires pip/poetry installed. Works with Bash projects. Review the
