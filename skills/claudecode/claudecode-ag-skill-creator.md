---
id: claudecode-ag-skill-creator
stackId: claudecode
type: skill
name: Skill Creation Framework
description: >-
...
compatibility:
  ...
  - codex
faq:
  - question: "When should I use the Skill Creation Framework skill?"
    answer: >-
      This skill should be used when the user asks to create a new skill,
      build a skill, make a custom skill, develop a CLI skill, or wants to
      extend the CLI with new capabilities. This skill provides a structured
      workflow for AI-assisted development, code generation, refactoring, and
      debugging.
  - question: "What tools and setup does Skill Creation Framework require?"
    answer: >-
