---
id: claudecode-claude-code-guide
stackId: claudecode
type: skill
...
compatibility:
  - claude-code
faq:
  - question: "When should I use the Claude Code Guide skill?"
    answer: >-
      Master guide for using Claude Code effectively. This skill provides a
      structured workflow for AI-assisted development, code generation,
      refactoring, and debugging.
  - question: "What tools and setup does Claude Code Guide require?"
    answer: >-
