---
id: claudecode-mcp-builder-ms
stackId: claudecode
type: skill
name: MCP Server Builder (Microsoft)
description: >-
...
compatibility:
  ...
  - copilot
faq:
  - question: "When should I use the MCP Server Builder (Microsoft) skill?"
    answer: >-
  ...
  - question: "What tools and setup does MCP Server Builder (Microsoft) require?"
    answer: >-
      Requires npm/yarn/pnpm, Docker, Playwright installed. Works with Claude
      Code projects. Review the configuration section for project-specific
      setup.
version: "1.0.0"
