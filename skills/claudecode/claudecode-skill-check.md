...
compatibility:
  - claude-code
faq:
  - question: "When should I use the Skill Check skill?"
    answer: >-
      Validate Claude Code skills against the agentskills specification. This
      skill provides a structured workflow for AI-assisted development, code
      generation, refactoring, and debugging.
  - question: "What tools and setup does Skill Check require?"
    answer: >-
