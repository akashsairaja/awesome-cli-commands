---
id: claudecode-skill-creator-ms
stackId: claudecode
type: skill
name: Skill Creator (Azure/Microsoft)
description: >-
  Guide for creating effective skills for AI coding agents working with Azure
  SDKs and Microsoft Foundry services.
difficulty: advanced
tags:
  - claudecode
  - creator
...
compatibility:
  - claude-code
faq:
  - question: "When should I use the Skill Creator (Azure/Microsoft) skill?"
    answer: >-
      Guide for creating effective skills for AI coding agents working with
      Azure SDKs and Microsoft Foundry services. This skill provides a
      structured workflow for AI-assisted development, code generation,
      refactoring, and debugging.
  - question: "What tools and setup does Skill Creator (Azure/Microsoft) require?"
    answer: >-
