...
compatibility:
  - claude-code
faq:
  - question: "When should I use the Skill Router skill?"
    answer: >-
      Use when the user is unsure which skill to use or where to start. This
      skill provides a structured workflow for AI-assisted development, code
      generation, refactoring, and debugging.
  - question: "What tools and setup does Skill Router require?"
    answer: >-
      Requires pip/poetry installed. Works with Claude Code projects. No
