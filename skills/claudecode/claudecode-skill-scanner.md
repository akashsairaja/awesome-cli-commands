---
id: claudecode-skill-scanner
stackId: claudecode
type: skill
name: Skill Scanner
description: >-
  Scan agent skills for security issues before adoption. Detects prompt
  injection, malicious code, excessive permissions, secret exposure, and
  supply chain risks.
...
compatibility:
  - claude-code
faq:
  - question: "When should I use the Skill Scanner skill?"
    answer: >-
      Scan agent skills for security issues before adoption. Detects prompt
      injection, malicious code, excessive permissions, secret exposure, and
      supply chain risks. This skill provides a structured workflow for
      AI-assisted development, code generation, refactoring, and debugging.
  - question: "What tools and setup does Skill Scanner require?"
    answer: >-
