...
compatibility:
  ...
  - codex
faq:
  - question: "When should I use the Skill Writer skill?"
    answer: >-
      Create and improve agent skills following the Agent Skills
      specification. This skill provides a structured workflow for AI-assisted
      development, code generation, refactoring, and debugging.
  - question: "What tools and setup does Skill Writer require?"
    answer: >-
