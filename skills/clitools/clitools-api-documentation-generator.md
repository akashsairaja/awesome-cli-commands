---
id: clitools-api-documentation-generator
stackId: clitools
type: skill
...
compatibility:
  - claude-code
faq:
  - question: "When should I use the API Documentation Generator skill?"
    answer: >-
      Generate comprehensive, developer-friendly API documentation from code,
      including endpoints, parameters, examples, and best practices. This
      skill provides a structured workflow for API design, documentation,
      architecture patterns, and development workflows.
  - question: "What tools and setup does API Documentation Generator require?"
    answer: >-
