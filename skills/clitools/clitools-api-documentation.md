---
id: clitools-api-documentation
stackId: clitools
type: skill
name: API Documentation
description: >-
  API documentation workflow for generating OpenAPI specs, creating developer
  guides, and maintaining comprehensive API documentation.
difficulty: advanced
tags:
  - clitools
  - api
...
compatibility:
  - claude-code
faq:
  - question: "When should I use the API Documentation skill?"
    answer: >-
      API documentation workflow for generating OpenAPI specs, creating
      developer guides, and maintaining comprehensive API documentation. This
      skill provides a structured workflow for API design, documentation,
      architecture patterns, and development workflows.
  - question: "What tools and setup does API Documentation require?"
    answer: >-
