---
id: clitools-api-fuzzing-bug-bounty
stackId: clitools
type: skill
name: API Fuzzing Bug Bounty
description: >-
  This skill should be used when the user asks to "test API security", "fuzz
  APIs", "find IDOR vulnerabilities", "test REST API", "test GraphQL", "API
  penetration testing", "bug b.
difficulty: advanced
tags:
  - clitools
  - api
...
compatibility:
  - claude-code
faq:
  - question: "When should I use the API Fuzzing Bug Bounty skill?"
    answer: >-
      This skill should be used when the user asks to "test API security",
      "fuzz APIs", "find IDOR vulnerabilities", "test REST API", "test
      GraphQL", "API penetration testing", "bug b. This skill provides a
      structured workflow for API design, documentation, architecture
      patterns, and development workflows.
  - question: "What tools and setup does API Fuzzing Bug Bounty require?"
    answer: >-
