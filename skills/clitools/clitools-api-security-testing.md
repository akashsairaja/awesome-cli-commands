---
id: clitools-api-security-testing
stackId: clitools
type: skill
name: API Security Testing
description: >-
  API security testing workflow for REST and GraphQL APIs covering
  authentication, authorization, rate limiting, input validation, and security
  best practices.
...
compatibility:
  - claude-code
faq:
  - question: "When should I use the API Security Testing skill?"
    answer: >-
      API security testing workflow for REST and GraphQL APIs covering
      authentication, authorization, rate limiting, input validation, and
      security best practices. This skill provides a structured workflow for
      API design, documentation, architecture patterns, and development
      workflows.
  - question: "What tools and setup does API Security Testing require?"
    answer: >-
