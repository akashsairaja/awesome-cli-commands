---
id: clitools-clean-code
stackId: clitools
type: skill
name: Clean Code
description: >-
  This skill embodies the principles of "Clean Code" by Robert C. Martin
  (Uncle Bob).
...
compatibility:
  - claude-code
faq:
  - question: "When should I use the Clean Code skill?"
    answer: >-
      This skill embodies the principles of "Clean Code" by Robert C. Martin
      (Uncle Bob). It includes practical examples for developer tooling
      development.
  - question: "What tools and setup does Clean Code require?"
    answer: >-
