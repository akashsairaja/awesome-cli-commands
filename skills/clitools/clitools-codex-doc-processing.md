---
id: clitools-codex-doc-processing
stackId: clitools
type: skill
name: Document Processing
description: >-
  - Read or review DOCX content where layout matters (tables, diagrams,
  pagination). - Create or edit DOCX files with professional formatting.
...
compatibility:
  - codex
faq:
  - question: "When should I use the Document Processing skill?"
    answer: >-
      - Read or review DOCX content where layout matters (tables, diagrams,
      pagination). - Create or edit DOCX files with professional formatting.
      This skill provides a structured workflow for API design, documentation,
      architecture patterns, and development workflows.
  - question: "What tools and setup does Document Processing require?"
    answer: >-
