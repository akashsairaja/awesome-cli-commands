---
id: clitools-codex-screenshot
stackId: clitools
type: skill
name: Screenshot Capture Automation
description: >-
...
compatibility:
  - codex
faq:
  - question: "When should I use the Screenshot Capture Automation skill?"
    answer: >-
      Use when the user explicitly asks for a desktop or system screenshot
      (full screen, specific app or window, or a pixel region), or when
      tool-specific capture capabilities are unavailable and an OS-level
      capture is needed. This skill provides a structured workflow for API
      design, documentation, architecture patterns, and development workflows.
  - question: "What tools and setup does Screenshot Capture Automation require?"
    answer: >-
      Requires Playwright installed. Works with CLI & Dev Tools projects. No
