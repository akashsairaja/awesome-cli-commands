...
compatibility:
  - codex
faq:
  - question: "When should I use the Slide Deck Generation skill?"
    answer: >-
      Create and edit presentation slide decks (`. This skill provides a
      structured workflow for API design, documentation, architecture
      patterns, and development workflows.
  - question: "What tools and setup does Slide Deck Generation require?"
    answer: >-
