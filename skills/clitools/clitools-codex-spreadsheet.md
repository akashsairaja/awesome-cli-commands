---
id: clitools-codex-spreadsheet
stackId: clitools
type: skill
name: Spreadsheet Processing
description: >-
  Use when tasks involve creating, editing, analyzing, or formatting
  spreadsheets (`.
...
compatibility:
  - codex
faq:
  - question: "When should I use the Spreadsheet Processing skill?"
    answer: >-
      Use when tasks involve creating, editing, analyzing, or formatting
      spreadsheets (`. This skill provides a structured workflow for API
      design, documentation, architecture patterns, and development workflows.
  - question: "What tools and setup does Spreadsheet Processing require?"
    answer: >-
