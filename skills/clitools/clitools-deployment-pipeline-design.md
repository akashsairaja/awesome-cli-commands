---
id: clitools-deployment-pipeline-design
stackId: clitools
type: skill
name: Deployment Pipeline Design
description: >-
  Design multi-stage CI/CD pipelines with approval gates, security checks, and
...
compatibility:
  - claude-code
faq:
  - question: When should I use the Deployment Pipeline Design skill?
    answer: >-
      Design multi-stage CI/CD pipelines with approval gates, security checks,
      and deployment orchestration. This skill provides a structured workflow
      for API design, documentation, architecture patterns, and development
      workflows.
  - question: What tools and setup does Deployment Pipeline Design require?
    answer: >-
      Requires pip/poetry installed. Works with CLI & Dev Tools projects. Review
