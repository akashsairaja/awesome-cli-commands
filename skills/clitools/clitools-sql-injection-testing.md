---
id: clitools-sql-injection-testing
stackId: clitools
type: skill
name: SQL Injection Testing
description: >-
  This skill should be used when the user asks to "test for SQL injection
  vulnerabilities", "perform SQLi attacks", "bypass authentication using SQL
  injection", "extract database inform.
difficulty: advanced
tags:
  - clitools
  - sql
...
compatibility:
  - claude-code
faq:
  - question: "When should I use the SQL Injection Testing skill?"
    answer: >-
      This skill should be used when the user asks to "test for SQL injection
      vulnerabilities", "perform SQLi attacks", "bypass authentication using
      SQL injection", "extract database inform. This skill provides a
      structured workflow for API design, documentation, architecture
      patterns, and development workflows.
  - question: "What tools and setup does SQL Injection Testing require?"
    answer: >-
