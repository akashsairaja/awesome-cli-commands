---
id: clitools-test-fixing
stackId: clitools
type: skill
name: Test Fixing
description: >-
  Run tests and systematically fix all failing tests using smart error
  grouping.
difficulty: beginner
tags:
  - clitools
...
compatibility:
  - claude-code
faq:
  - question: "When should I use the Test Fixing skill?"
    answer: >-
      Run tests and systematically fix all failing tests using smart error
      grouping. This skill provides a structured workflow for API design,
      documentation, architecture patterns, and development workflows.
  - question: "What tools and setup does Test Fixing require?"
    answer: >-
