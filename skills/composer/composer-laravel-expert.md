---
id: composer-laravel-expert
stackId: composer
type: skill
name: Laravel Expert
description: >-
  Senior Laravel Engineer role for production-grade, maintainable, and
  idiomatic Laravel solutions.
difficulty: beginner
tags:
  - composer
  - laravel
...
compatibility:
  - claude-code
faq:
  - question: "When should I use the Laravel Expert skill?"
    answer: >-
      Senior Laravel Engineer role for production-grade, maintainable, and
      idiomatic Laravel solutions. It includes practical examples for PHP
      development development.
  - question: "What tools and setup does Laravel Expert require?"
    answer: >-
