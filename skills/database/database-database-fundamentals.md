---
id: database-database-fundamentals
stackId: database
type: skill
name: Database Fundamentals
description: >-
  Database development and operations workflow covering SQL, NoSQL, database
...
compatibility:
  - claude-code
faq:
  - question: "When should I use the Database Fundamentals skill?"
    answer: >-
      Database development and operations workflow covering SQL, NoSQL,
      database design, migrations, optimization, and data engineering. This
      skill provides a structured workflow for schema design, query
      optimization, migration strategies, and data modeling.
  - question: "What tools and setup does Database Fundamentals require?"
    answer: >-
      Requires pip/poetry installed. Works with Database projects. Review the
