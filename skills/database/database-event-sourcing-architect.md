---
id: database-event-sourcing-architect
stackId: database
type: skill
...
compatibility:
  - claude-code
faq:
  - question: "When should I use the Event Sourcing Architect skill?"
    answer: >-
      Expert in event sourcing, CQRS, and event-driven architecture patterns.
      This skill provides a structured workflow for schema design, query
      optimization, migration strategies, and data modeling.
  - question: "What tools and setup does Event Sourcing Architect require?"
    answer: >-
