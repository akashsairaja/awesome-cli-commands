---
id: database-migration-observability
stackId: database
type: skill
...
compatibility:
  - claude-code
faq:
  - question: "When should I use the Migration Observability skill?"
    answer: >-
      Migration monitoring, CDC, and observability infrastructure. This skill
      provides a structured workflow for schema design, query optimization,
      migration strategies, and data modeling.
  - question: "What tools and setup does Migration Observability require?"
    answer: >-
