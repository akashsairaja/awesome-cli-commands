---
id: django-django-access-review
stackId: django
type: skill
name: Django Access Review
description: >-
  name: django-access-review description: Django access control and IDOR
  security review. Use when reviewing Django views, DRF viewsets, ORM queries,
  or any Python/Django code handling user authorization.
difficulty: advanced
tags:
  - django
  - access
...
compatibility:
  - claude-code
faq:
  - question: "When should I use the Django Access Review skill?"
    answer: >-
      name: django-access-review description: Django access control and IDOR
      security review. Use when reviewing Django views, DRF viewsets, ORM
      queries, or any Python/Django code handling user authorization. It
      includes practical examples for Django web development.
  - question: "What tools and setup does Django Access Review require?"
    answer: >-
      Works with standard Django tooling (Django CLI, Django ORM). No special
      setup required beyond a working Django web environment.
version: "1.0.0"
