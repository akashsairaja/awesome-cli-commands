---
id: django-django-perf-review
stackId: django
type: skill
name: Django Perf Review
description: >-
  Review Django code for **validated** performance issues. Research the
  codebase to confirm issues before reporting.
difficulty: advanced
tags:
  - django
  - perf
...
compatibility:
  - claude-code
faq:
  - question: "When should I use the Django Perf Review skill?"
    answer: >-
      Review Django code for **validated** performance issues. Research the
      codebase to confirm issues before reporting. It includes practical
      examples for Django web development.
  - question: "What tools and setup does Django Perf Review require?"
    answer: >-
