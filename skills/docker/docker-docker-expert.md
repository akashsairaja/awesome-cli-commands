...
compatibility:
  - claude-code
faq:
  - question: "When should I use the Docker Expert skill?"
    answer: >-
      Docker containerization expert with deep knowledge of multi-stage
      builds, image optimization, container security, Docker Compose
      orchestration, and production deployment patterns. This skill provides a
      structured workflow for image optimization, multi-stage builds,
      networking, and container orchestration.
  - question: "What tools and setup does Docker Expert require?"
    answer: >-
      Requires Docker installed. Works with Docker projects. Review the
