...
compatibility:
  - claude-code
faq:
  - question: "When should I use the GCP Cloud Run skill?"
    answer: >-
      Specialized skill for building production-ready serverless applications
      on GCP. This skill provides a structured workflow for Cloud Run
      deployment, GKE configuration, IAM setup, and resource management.
  - question: "What tools and setup does GCP Cloud Run require?"
    answer: >-
      Requires npm/yarn/pnpm, Docker installed. Works with Google Cloud
