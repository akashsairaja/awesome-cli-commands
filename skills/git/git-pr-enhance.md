...
description: >-
  You are a PR optimization expert specializing in creating high-quality pull
  requests that facilitate efficient code reviews.
difficulty: beginner
tags:
  - git
  - workflows
...
compatibility:
  - claude-code
faq:
  - question: When should I use the Git Pr Workflows Pr Enhance skill?
    answer: >-
      You are a PR optimization expert specializing in creating high-quality
      pull requests that facilitate efficient code reviews. This skill provides
      a structured workflow for branching strategies, workflow automation, hook
      scripts, and repository maintenance.
  - question: What tools and setup does Git Pr Workflows Pr Enhance require?
    answer: >-
