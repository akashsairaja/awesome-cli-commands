...
description: >-
  Generate failing tests for the TDD red phase to define expected behavior and
  edge cases.
difficulty: beginner
tags:
  - git
...
compatibility:
  - claude-code
faq:
  - question: "When should I use the TDD Red Phase (Write Failing Tests) skill?"
    answer: >-
      Generate failing tests for the TDD red phase to define expected behavior
      and edge cases. It includes practical examples for version control
      development.
  - question: "What tools and setup does TDD Red Phase (Write Failing Tests) require?"
    answer: >-
      Requires Jest installed. Works with Git projects. Review the
