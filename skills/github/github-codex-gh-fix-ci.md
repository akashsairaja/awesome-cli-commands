---
id: github-codex-gh-fix-ci
stackId: github
type: skill
name: GitHub CI Fix Automation
description: >-
  ...
  context, draft a fix plan, and implement only after explicit approval.
difficulty: beginner
tags:
  - github
  - fix
...
compatibility:
  - codex
faq:
  - question: "When should I use the GitHub CI Fix Automation skill?"
    answer: >-
      Use when a user asks to debug or fix failing GitHub PR checks that run
      in GitHub Actions; use `gh` to inspect checks and logs, summarize
      failure context, draft a fix plan, and implement only after explicit
      approval. This skill provides a structured workflow for CI/CD workflows,
      PR automation, issue management, and repository configuration.
  - question: "What tools and setup does GitHub CI Fix Automation require?"
    answer: >-
