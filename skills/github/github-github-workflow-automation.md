---
id: github-github-workflow-automation
stackId: github
type: skill
...
compatibility:
  - claude-code
faq:
  - question: "When should I use the Github Workflow Automation skill?"
    answer: >-
      Automate GitHub workflows with AI assistance. This skill provides a
      structured workflow for CI/CD workflows, PR automation, issue
      management, and repository configuration.
  - question: "What tools and setup does Github Workflow Automation require?"
    answer: >-
      Requires pip/poetry installed. Works with GitHub projects. Review the
