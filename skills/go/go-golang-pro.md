...
name: Golang Pro
description: >-
  You are a Go expert specializing in modern Go 1.21+ development with
  advanced concurrency patterns, performance optimization, and
...
compatibility:
  - claude-code
faq:
  - question: "When should I use the Golang Pro skill?"
    answer: >-
      You are a Go expert specializing in modern Go 1.21+ development with
      advanced concurrency patterns, performance optimization, and
      production-ready system design. It includes practical examples for Go
      backend development.
  - question: "What tools and setup does Golang Pro require?"
    answer: >-
      Requires pip/poetry installed. Works with Go projects. Review the
