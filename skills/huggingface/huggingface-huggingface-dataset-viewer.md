---
id: huggingface-huggingface-dataset-viewer
stackId: huggingface
type: skill
name: Hugging Face Dataset Viewer
description: >-
  Use this skill for Hugging Face Dataset Viewer API workflows that fetch
  subset/split metadata, paginate rows, search text, apply filters, download
  parquet URLs, and read size or statistics.
...
compatibility:
  - claude-code
faq:
  - question: "When should I use the Hugging Face Dataset Viewer skill?"
    answer: >-
      Use this skill for Hugging Face Dataset Viewer API workflows that fetch
      subset/split metadata, paginate rows, search text, apply filters,
      download parquet URLs, and read size or statistics. This skill provides
      a structured workflow for model management, dataset handling,
      fine-tuning, and ML pipeline deployment.
  - question: "What tools and setup does Hugging Face Dataset Viewer require?"
    answer: >-
