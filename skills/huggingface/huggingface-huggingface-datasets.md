...
compatibility:
  - claude-code
faq:
  - question: "When should I use the Hugging Face Datasets skill?"
    answer: >-
      Create and manage datasets on Hugging Face Hub. This skill provides a
      structured workflow for model management, dataset handling, fine-tuning,
      and ML pipeline deployment.
  - question: "What tools and setup does Hugging Face Datasets require?"
    answer: >-
