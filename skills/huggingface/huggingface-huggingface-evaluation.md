---
id: huggingface-huggingface-evaluation
stackId: huggingface
type: skill
...
compatibility:
  - claude-code
faq:
  - question: "When should I use the Hugging Face Evaluation skill?"
    answer: >-
      Add and manage evaluation results in Hugging Face model cards. This
      skill provides a structured workflow for model management, dataset
      handling, fine-tuning, and ML pipeline deployment.
  - question: "What tools and setup does Hugging Face Evaluation require?"
    answer: >-
