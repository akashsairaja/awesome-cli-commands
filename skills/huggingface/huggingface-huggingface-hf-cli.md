---
id: huggingface-huggingface-hf-cli
stackId: huggingface
type: skill
name: HF CLI
description: >-
...
compatibility:
  - claude-code
faq:
  - question: "When should I use the HF CLI skill?"
    answer: >-
      Hugging Face Hub CLI (`hf`) for downloading, uploading, and managing
      repositories, models, datasets, and Spaces on the Hugging Face Hub. It
      includes practical examples for ML/AI platform development.
  - question: "What tools and setup does HF CLI require?"
    answer: >-
