---
id: huggingface-huggingface-model-trainer
stackId: huggingface
type: skill
...
compatibility:
  - claude-code
faq:
  - question: "When should I use the Hugging Face Model Trainer skill?"
    answer: >-
      This skill should be used when users want to train or fine-tune language
      models using TRL (Transformer Reinforcement Learning) on Hugging Face
      Jobs infrastructure. This skill provides a structured workflow for model
      management, dataset handling, fine-tuning, and ML pipeline deployment.
  - question: "What tools and setup does Hugging Face Model Trainer require?"
    answer: >-
