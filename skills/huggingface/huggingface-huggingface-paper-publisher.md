...
compatibility:
  - claude-code
faq:
  - question: "When should I use the Hugging Face Paper Publisher skill?"
    answer: >-
      Publish and manage research papers on Hugging Face Hub. This skill
      provides a structured workflow for model management, dataset handling,
      fine-tuning, and ML pipeline deployment.
  - question: "What tools and setup does Hugging Face Paper Publisher require?"
    answer: >-
