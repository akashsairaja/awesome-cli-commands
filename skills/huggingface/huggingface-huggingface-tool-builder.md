...
description: >-
  Use this skill when the user wants to build tool/scripts or achieve a task
  where using data from the Hugging Face API would help.
...
compatibility:
  - claude-code
faq:
  - question: "When should I use the Hugging Face Tool Builder skill?"
    answer: >-
      Use this skill when the user wants to build tool/scripts or achieve a
      task where using data from the Hugging Face API would help. This skill
      provides a structured workflow for model management, dataset handling,
      fine-tuning, and ML pipeline deployment.
  - question: "What tools and setup does Hugging Face Tool Builder require?"
    answer: >-
      Requires pip/poetry installed. Works with Hugging Face projects. No
