---
id: huggingface-huggingface-transformers-js
stackId: huggingface
type: skill
name: Transformers Js
description: >-
  Transformers.js enables running state-of-the-art machine learning models
  directly in JavaScript, both in browsers and Node.
difficulty: advanced
tags:
  - huggingface
  - transformers
...
compatibility:
  - claude-code
faq:
  - question: "When should I use the Transformers Js skill?"
    answer: >-
      Transformers.js enables running state-of-the-art machine learning models
      directly in JavaScript, both in browsers and Node. It includes practical
      examples for ML/AI platform development.
  - question: "What tools and setup does Transformers Js require?"
    answer: >-
      Requires npm/yarn/pnpm, pip/poetry installed. Works with Hugging Face
