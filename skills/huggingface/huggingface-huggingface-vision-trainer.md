...
description: >-
  Trains and fine-tunes vision models for object detection (D-FINE, RT-DETR
  v2, DETR, YOLOS), image classification (timm models — MobileNetV3,
...
compatibility:
  - claude-code
faq:
  - question: "When should I use the Hugging Face Vision Trainer skill?"
    answer: >-
      Trains and fine-tunes vision models for object detection (D-FINE,
      RT-DETR v2, DETR, YOLOS), image classification (timm models —
      MobileNetV3, MobileViT, ResNet, ViT/DINOv3 — plus any Transformers
      classifier), and SAM/SAM2 segmentation using Hugging Face Transformers
      on Hugging Face Jobs cloud GPUs. This skill provides a structured
      workflow for model management, dataset handling, fine-tuning, and ML
      pipeline deployment.
  - question: "What tools and setup does Hugging Face Vision Trainer require?"
    answer: >-
      Requires pip/poetry installed. Works with Hugging Face projects. Review
