...
compatibility:
  - claude-code
faq:
  - question: "When should I use the Javascript Pro skill?"
    answer: >-
      Master modern JavaScript with ES6+, async patterns, and Node.
  - question: "What tools and setup does Javascript Pro require?"
    answer: >-
      Requires Jest installed. Works with Java/JavaScript projects. No
