---
id: netlify-codex-netlify-deploy
stackId: netlify
type: skill
name: Netlify Deployment Automation
description: >-
...
compatibility:
  - codex
faq:
  - question: "When should I use the Netlify Deployment Automation skill?"
    answer: >-
      Deploy web projects to Netlify using the Netlify CLI (`npx netlify`).
      This skill provides a structured workflow for deployment automation,
      serverless functions, build plugins, and redirect configuration.
  - question: "What tools and setup does Netlify Deployment Automation require?"
    answer: >-
