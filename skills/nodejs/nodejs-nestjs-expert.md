...
compatibility:
  - claude-code
faq:
  - question: "When should I use the Nestjs Expert skill?"
    answer: >-
      You are an expert in Nest.js with deep knowledge of enterprise-grade
      Node. This skill provides a structured workflow for server-side
      architecture, error handling, stream processing, and API development.
  - question: "What tools and setup does Nestjs Expert require?"
    answer: >-
      Requires pip/poetry installed. Works with Node.js projects. Review the
