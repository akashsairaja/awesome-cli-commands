---
id: nuget-codex-aspnet-core
stackId: nuget
type: skill
name: ASP.NET Core Development
description: >-
  Build, review, refactor, or architect ASP.
difficulty: beginner
tags:
  - nuget
  - aspnet
...
compatibility:
  - codex
faq:
  - question: "When should I use the ASP.NET Core Development skill?"
    answer: >-
      Build, review, refactor, or architect ASP. This skill provides a
      structured workflow for package management, ASP.NET patterns, and .NET
      application development.
  - question: "What tools and setup does ASP.NET Core Development require?"
    answer: >-
