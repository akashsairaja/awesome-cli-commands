---
id: playwright-codex-playwright-interactive
stackId: playwright
type: skill
name: Playwright Interactive Testing
description: >-
  Persistent browser and Electron interaction through `js_repl` for fast
...
compatibility:
  - codex
faq:
  - question: "When should I use the Playwright Interactive Testing skill?"
    answer: >-
      Persistent browser and Electron interaction through `js_repl` for fast
      iterative UI debugging. This skill provides a structured workflow for
      end-to-end testing, visual regression, API testing, and CI/CD
      integration.
  - question: "What tools and setup does Playwright Interactive Testing require?"
    answer: >-
