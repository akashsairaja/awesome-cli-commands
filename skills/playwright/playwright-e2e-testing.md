...
name: E2e Testing
description: >-
  End-to-end testing workflow with Playwright for browser automation, visual
...
compatibility:
  - claude-code
faq:
  - question: "When should I use the E2e Testing skill?"
    answer: >-
      End-to-end testing workflow with Playwright for browser automation,
      visual regression, cross-browser testing, and CI/CD integration. This
      skill provides a structured workflow for end-to-end testing, visual
      regression, API testing, and CI/CD integration.
  - question: "What tools and setup does E2e Testing require?"
    answer: >-
