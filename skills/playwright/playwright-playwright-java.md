---
id: playwright-playwright-java
stackId: playwright
type: skill
name: Playwright Java
description: >-
  Scaffold, write, debug, and enhance enterprise-grade Playwright E2E tests in
  Java using Page Object Model, JUnit 5, Allure reporting, and parallel
  execution.
difficulty: advanced
tags:
  - playwright
...
compatibility:
  - claude-code
faq:
  - question: "When should I use the Playwright Java skill?"
    answer: >-
      Scaffold, write, debug, and enhance enterprise-grade Playwright E2E
      tests in Java using Page Object Model, JUnit 5, Allure reporting, and
      parallel execution. This skill provides a structured workflow for
      end-to-end testing, visual regression, API testing, and CI/CD
      integration.
  - question: "What tools and setup does Playwright Java require?"
    answer: >-
      Requires Docker, pip/poetry, Playwright installed. Works with Playwright
