---
id: postgresql-postgresql-skill
stackId: postgresql
type: skill
name: PostgreSQL Best Practices
description: >-
  - Designing a schema for PostgreSQL - Selecting data types and constraints -
...
compatibility:
  - claude-code
faq:
  - question: "When should I use the PostgreSQL Best Practices skill?"
    answer: >-
      - Designing a schema for PostgreSQL - Selecting data types and
      constraints - Planning indexes, partitions, or RLS policies. It includes
      practical examples for PostgreSQL database development.
  - question: "What tools and setup does PostgreSQL Best Practices require?"
    answer: >-
