---
id: postgresql-sql-pro
stackId: postgresql
type: skill
name: SQL Pro
description: >-
  Master modern SQL with cloud-native databases, OLTP/OLAP optimization, and
...
compatibility:
  - claude-code
faq:
  - question: "When should I use the SQL Pro skill?"
    answer: >-
      Master modern SQL with cloud-native databases, OLTP/OLAP optimization,
      and advanced query techniques. It includes practical examples for
      PostgreSQL database development.
  - question: "What tools and setup does SQL Pro require?"
    answer: >-
