---
id: powershell-codex-winui
stackId: powershell
type: skill
name: WinUI Desktop App Development
description: >-
  Bootstrap, develop, and design modern WinUI 3 desktop applications with C#
  and the Windows App SDK using official Microsoft guidance, WinUI Gallery
  patterns, Windows App SDK samples, and CommunityToolkit components.
...
compatibility:
  - codex
faq:
  - question: "When should I use the WinUI Desktop App Development skill?"
    answer: >-
      Bootstrap, develop, and design modern WinUI 3 desktop applications with
      C# and the Windows App SDK using official Microsoft guidance, WinUI
      Gallery patterns, Windows App SDK samples, and CommunityToolkit
      components. This skill provides a structured workflow for system
      administration, script automation, pipeline operations, and remote
      management.
  - question: "What tools and setup does WinUI Desktop App Development require?"
    answer: >-
