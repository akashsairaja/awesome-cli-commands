---
id: prisma-prisma-expert
stackId: prisma
type: skill
name: Prisma Expert
description: >-
  Prisma ORM expert for schema design, migrations, query optimization,
  relations modeling, and database operations.
difficulty: advanced
tags:
  - prisma
  - expert
...
compatibility:
  - claude-code
faq:
  - question: "When should I use the Prisma Expert skill?"
    answer: >-
      Prisma ORM expert for schema design, migrations, query optimization,
      relations modeling, and database operations. This skill provides a
      structured workflow for schema design, migration workflows, query
      optimization, and database seeding.
  - question: "What tools and setup does Prisma Expert require?"
    answer: >-
      Requires Prisma CLI installed. Works with Prisma projects. Review the
