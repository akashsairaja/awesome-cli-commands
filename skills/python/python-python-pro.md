...
compatibility:
  - claude-code
faq:
  - question: "When should I use the Python Pro skill?"
    answer: >-
      You are a Python expert specializing in modern Python 3.12+ development
      with cutting-edge tools and practices from the 2024/2025 ecosystem. This
      skill provides a structured workflow for package management, testing,
      async patterns, and project scaffolding.
  - question: "What tools and setup does Python Pro require?"
    answer: >-
