...
compatibility:
  - claude-code
faq:
  - question: "When should I use the Python Project Scaffolding skill?"
    answer: >-
      You are a Python project architecture expert specializing in scaffolding
      production-ready Python applications. This skill provides a structured
      workflow for package management, testing, async patterns, and project
      scaffolding.
  - question: "What tools and setup does Python Project Scaffolding require?"
    answer: >-
