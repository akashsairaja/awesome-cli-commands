---
id: react-codex-figma-implement
stackId: react
type: skill
...
compatibility:
  - codex
faq:
  - question: "When should I use the Figma to Code Implementation skill?"
    answer: >-
      Translate Figma nodes into production-ready code with 1:1 visual
      fidelity using the Figma MCP workflow (design context, screenshots,
      assets, and project-convention translation). This skill provides a
      structured workflow for component architecture, state management,
      performance optimization, and UI patterns.
  - question: "What tools and setup does Figma to Code Implementation require?"
    answer: >-
