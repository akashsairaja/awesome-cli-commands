---
id: react-codex-web-game
stackId: react
type: skill
name: Web Game Development
description: >-
  Use when Codex is building or iterating on a web game (HTML/JS) and needs a
  reliable development + testing loop: implement small changes, run a
  Playwright-based test script with short input bursts and intentional pauses,
  inspect screenshots/text, and review console errors with
  render_game_to_text.
...
compatibility:
  - codex
faq:
  - question: "When should I use the Web Game Development skill?"
    answer: >-
      Use when Codex is building or iterating on a web game (HTML/JS) and
      needs a reliable development + testing loop: implement small changes,
      run a Playwright-based test script with short input bursts and
      intentional pauses, inspect screenshots/text, and review console errors
      with render_game_to_text. This skill provides a structured workflow for
      component architecture, state management, performance optimization, and
      UI patterns.
  - question: "What tools and setup does Web Game Development require?"
    answer: >-
      Requires Playwright installed. Works with React projects. No additional
