---
id: react-react-flow-architect
stackId: react
type: skill
name: React Flow Architect
description: >-
  Expert ReactFlow architect for building interactive graph applications with
  hierarchical node-edge systems, performance optimization, and auto-layout
  integration.
difficulty: advanced
tags:
  - react
...
compatibility:
  - claude-code
faq:
  - question: "When should I use the React Flow Architect skill?"
    answer: >-
      Expert ReactFlow architect for building interactive graph applications
      with hierarchical node-edge systems, performance optimization, and
      auto-layout integration. This skill provides a structured workflow for
      component architecture, state management, performance optimization, and
      UI patterns.
  - question: "What tools and setup does React Flow Architect require?"
    answer: >-
