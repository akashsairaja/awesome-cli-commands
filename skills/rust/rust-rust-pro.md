...
compatibility:
  - claude-code
faq:
  - question: "When should I use the Rust Pro skill?"
    answer: >-
      You are a Rust expert specializing in modern Rust 1.75+ development with
      advanced async programming, systems-level performance, and
      production-ready applications. This skill provides a structured workflow
      for ownership patterns, async programming, error handling, and
      systems-level development.
  - question: "What tools and setup does Rust Pro require?"
    answer: >-
