---
id: snyk-security-hardening
stackId: snyk
type: skill
name: Security Hardening Practices
description: >-
  Coordinate multi-layer security scanning and hardening across application,
...
compatibility:
  - claude-code
faq:
  - question: "When should I use the Security Hardening Practices skill?"
    answer: >-
      Coordinate multi-layer security scanning and hardening across
      application, infrastructure, and compliance controls. This skill
      provides a structured workflow for dependency scanning, SAST analysis,
      container scanning, and vulnerability remediation.
  - question: "What tools and setup does Security Hardening Practices require?"
    answer: >-
