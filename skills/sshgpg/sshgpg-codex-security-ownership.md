---
id: sshgpg-codex-security-ownership
stackId: sshgpg
type: skill
name: Security Ownership Mapping
description: >-
  Analyze git repositories to build a security ownership topology
  (people-to-file), compute bus factor and sensitive-code ownership, and
  export CSV/JSON for graph databases and visualization.
difficulty: advanced
tags:
  - sshgpg
  - security
...
compatibility:
  - codex
faq:
  - question: "When should I use the Security Ownership Mapping skill?"
    answer: >-
      Analyze git repositories to build a security ownership topology
      (people-to-file), compute bus factor and sensitive-code ownership, and
      export CSV/JSON for graph databases and visualization. This skill
      provides a structured workflow for key management, secure connections,
      threat modeling, and security auditing.
  - question: "What tools and setup does Security Ownership Mapping require?"
    answer: >-
      Requires pip/poetry installed. Works with SSH/GPG Security projects.
