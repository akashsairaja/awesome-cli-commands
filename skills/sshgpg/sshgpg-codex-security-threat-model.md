---
id: sshgpg-codex-security-threat-model
stackId: sshgpg
type: skill
...
compatibility:
  - codex
faq:
  - question: "When should I use the Security Threat Modeling skill?"
    answer: >-
      Repository-grounded threat modeling that enumerates trust boundaries,
      assets, attacker capabilities, abuse paths, and mitigations, and writes
      a concise Markdown threat model. This skill provides a structured
      workflow for key management, secure connections, threat modeling, and
      security auditing.
  - question: "What tools and setup does Security Threat Modeling require?"
    answer: >-
