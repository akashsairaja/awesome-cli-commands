...
compatibility:
  - claude-code
faq:
  - question: "When should I use the Security Audit skill?"
    answer: >-
      Comprehensive security auditing workflow covering web application
      testing, API security, penetration testing, vulnerability scanning, and
      security hardening. This skill provides a structured workflow for key
      management, secure connections, threat modeling, and security auditing.
  - question: "What tools and setup does Security Audit require?"
    answer: >-
