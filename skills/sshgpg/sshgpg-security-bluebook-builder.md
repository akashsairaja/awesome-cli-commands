---
id: sshgpg-security-bluebook-builder
stackId: sshgpg
type: skill
name: Security Bluebook Builder
description: >-
  Create or refine a concise, normative security policy ("Blue Book") for
...
compatibility:
  - claude-code
faq:
  - question: "When should I use the Security Bluebook Builder skill?"
    answer: >-
      Create or refine a concise, normative security policy ("Blue Book") for
      sensitive applications. This skill provides a structured workflow for
      key management, secure connections, threat modeling, and security
      auditing.
  - question: "What tools and setup does Security Bluebook Builder require?"
    answer: >-
      Works with standard SSH/GPG Security tooling (ssh, ssh-agent). No
      special setup required beyond a working security environment.
version: "1.0.0"
