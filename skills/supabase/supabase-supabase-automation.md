---
id: supabase-supabase-automation
stackId: supabase
type: skill
name: Supabase Automation
description: >-
  Automate Supabase database queries, table management, project
  administration, storage, edge functions, and SQL execution via Rube MCP
  (Composio).
...
compatibility:
  ...
  - cursor
faq:
  - question: "When should I use the Supabase Automation skill?"
    answer: >-
      Automate Supabase database queries, table management, project
      administration, storage, edge functions, and SQL execution via Rube MCP
      (Composio). This skill provides a structured workflow for auth
      configuration, database migrations, real-time subscriptions, and edge
      functions.
  - question: "What tools and setup does Supabase Automation require?"
    answer: >-
