---
id: terraform-terraform-infrastructure
stackId: terraform
type: skill
name: Terraform Infrastructure
description: >-
  Terraform infrastructure as code workflow for provisioning cloud resources,
...
compatibility:
  - claude-code
faq:
  - question: "When should I use the Terraform Infrastructure skill?"
    answer: >-
      Terraform infrastructure as code workflow for provisioning cloud
      resources, creating reusable modules, and managing infrastructure at
      scale. This skill provides a structured workflow for resource
      provisioning, state management, module design, and multi-cloud
      deployment.
  - question: "What tools and setup does Terraform Infrastructure require?"
    answer: >-
