---
id: terraform-terraform-skill
stackId: terraform
type: skill
name: Terraform Skill
description: >-
  Comprehensive Terraform and OpenTofu guidance covering testing, modules,
  CI/CD, and production patterns. Based on terraform-best-practices.com and
...
compatibility:
  - claude-code
faq:
  - question: "When should I use the Terraform Skill skill?"
    answer: >-
      Comprehensive Terraform and OpenTofu guidance covering testing, modules,
      CI/CD, and production patterns. Based on terraform-best-practices.com
      and enterprise experience. This skill provides a structured workflow for
      resource provisioning, state management, module design, and multi-cloud
      deployment.
  - question: "What tools and setup does Terraform Skill require?"
    answer: >-
