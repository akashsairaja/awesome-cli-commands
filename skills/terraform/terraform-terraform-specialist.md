---
id: terraform-terraform-specialist
stackId: terraform
type: skill
...
compatibility:
  - claude-code
faq:
  - question: "When should I use the Terraform Specialist skill?"
    answer: >-
      Expert Terraform/OpenTofu specialist mastering advanced IaC automation,
      state management, and enterprise infrastructure patterns. This skill
      provides a structured workflow for resource provisioning, state
      management, module design, and multi-cloud deployment.
  - question: "What tools and setup does Terraform Specialist require?"
    answer: >-
