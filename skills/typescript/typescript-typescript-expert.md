---
id: typescript-typescript-expert
stackId: typescript
type: skill
...
compatibility:
  ...
  - copilot
faq:
  - question: "When should I use the Typescript Expert skill?"
    answer: >-
      TypeScript and JavaScript expert with deep knowledge of type-level
      programming, performance optimization, monorepo management, migration
      strategies, and modern tooling. This skill provides a structured
      workflow for advanced type patterns, strict configuration, generic
      constraints, and type-safe development.
  - question: "What tools and setup does Typescript Expert require?"
    answer: >-
      Requires npm/yarn/pnpm, Jest installed. Works with TypeScript projects.
