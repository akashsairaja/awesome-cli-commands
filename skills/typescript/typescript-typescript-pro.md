...
compatibility:
  - claude-code
faq:
  - question: "When should I use the Typescript Pro skill?"
    answer: >-
      Master TypeScript with advanced types, generics, and strict type safety.
  - question: "What tools and setup does Typescript Pro require?"
    answer: >-
      Requires pip/poetry, Jest installed. Works with TypeScript projects.
