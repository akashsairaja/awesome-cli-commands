...
faq:
  - question: "When should I use the Vercel Deployment Automation skill?"
    answer: >-
      Deploy any project to Vercel instantly. **Always deploy as preview**
      (not production) unless the user explicitly asks for production. It
      includes practical examples for Vercel deployment development.
  - question: "What tools and setup does Vercel Deployment Automation require?"
    answer: >-
      Requires Vercel CLI installed. Works with Vercel projects. No additional
