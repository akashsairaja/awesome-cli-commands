---
id: vercel-vercel-automation
stackId: vercel
type: skill
name: Vercel Automation
description: >-
  Automate Vercel tasks via Rube MCP (Composio): manage deployments, domains,
  DNS, env vars, projects, and teams.
...
compatibility:
  - claude-code
faq:
  - question: "When should I use the Vercel Automation skill?"
    answer: >-
      Automate Vercel tasks via Rube MCP (Composio): manage deployments,
      domains, DNS, env vars, projects, and teams. This skill provides a
      structured workflow for deployment automation, edge functions,
      analytics, and monorepo configuration.
  - question: "What tools and setup does Vercel Automation require?"
    answer: >-
